...
l = La_Nacion()
l.guardar_xml('http://contenidos.lanacion.com.ar/herramientas/rss-categoria_id=30')
l.guardar_xml('http://contenidos.lanacion.com.ar/herramientas/rss-categoria_id=272')
l.guardar_xml('http://contenidos.lanacion.com.ar/herramientas/rss-categoria_id=7773')
l.guardar_xml('http://contenidos.lanacion.com.ar/herramientas/rss-categoria_id=7')
l.guardar_xml('http://contenidos.lanacion.com.ar/herramientas/rss-origen=2')
l.guardar_xml('http://contenidos.lanacion.com.ar/herramientas/rss-categoria_id=120')
p = Pagina_12()
